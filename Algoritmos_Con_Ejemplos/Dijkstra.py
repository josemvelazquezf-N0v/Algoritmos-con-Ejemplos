...
def dijkstra_step_by_step(graph, start, goal=None, delay=STEP_DELAY):
    ...
    # visited: aeropuertos ya "fijados" (precio mínimo confirmado)
    visited = set()
...
if __name__ == "__main__":
    ...
    vuelos = {
        "CDMX": {"LAX": 200, "JFK": 250, "MAD": 600}, # Desde Ciudad de México
        "LAX":  {"NRT": 800, "HNL": 300},             # Desde Los Ángeles
        "JFK":  {"LHR": 300, "MAD": 350},             # Desde Nueva York
        "MAD":  {"NRT": 700},                         # Desde Madrid
        "HNL":  {"NRT": 400},                         # Desde Honolulu
        "LHR":  {"NRT": 600},                         # Desde Londres
        "NRT":  {}                                    # Tokio (Destino, sin vuelos de salida aquí)
    }

    # Simulación: buscar el vuelo más barato de Ciudad de México a Tokio (Narita)
    dijkstra_step_by_step(vuelos, start="CDMX", goal="NRT")